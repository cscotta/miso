...
<jsp:include page="../includes/header.html" />
  ...
  <p>Here is all of the info we have about this [[ModelNameLowercase]]. <a href="/java/app?controller=[[ModelNameLowercase]]&amp;action=add">Add another [[ModelNameLowercase]]</a>, or <a href="/java/app?controller=[[ModelNameLowercase]]&amp;action=index">list all of them</a>.</p>
